...
class WatchStateLoggerPlugin {
     ...
     */
    static rewriteHotUpdateChunk(compiler, compilation, emittedFiles) {
        ...
        const absolutePath = path_1.join(compiler.outputPath, chunk);
        const newContent = this.getWebpackHotUpdateReplacementContent(compilation.errors, absolutePath, name);
        fs_1.writeFileSync(absolutePath, newContent);
    }
    static findHotUpdateChunk(emittedFiles) {
     ...
     */
    static getModulesObjectFromChunk(chunkPath) {
        let content = fs_1.readFileSync(chunkPath, "utf8");
     ...
     */
    static getWebpackHotUpdateReplacementContent(compilationErrors, filePath, moduleName) {
     ...
     */
    static parseHotUpdateChunkName(name) {
